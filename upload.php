...
$applicationDescription	= 'Web page to upload links and objects from code master.';
						// Page web de chargement des liens et objets de l'autorité du code.
	...
	<head>
		...
		<style type="text/css">
			...
			.layout-content > div { min-width: 400px; margin-bottom:20px; text-align:left; color:#ababab; white-space:normal; }
	   		h1 { font-family:monospace; font-size:1.4em; font-weight:normal; color:#ababab; }
			.newlink { width:100%; }
...
?>
				...
				<div>
					...
					<div>
						<form enctype="multipart/form-data" method="post" action="<?php echo '?'.$this->_nebuleInstance->getActionTicket(); ?>">
