...
<html>
	<head>
		...
		<style type="text/css">
			...
			.layout-content > div { min-width: 400px; margin-bottom:20px; text-align:left; color:#ababab; white-space:normal; }
			.header-center > div { margin:auto 3px 3px 3px; overflow:hidden; white-space:nowrap; color:#454545; text-align:center; }
	   		h1 { font-family:monospace; font-size:1.8em; font-weight:normal; color:#ababab; margin-top:10px; }
	   		h2 { font-family:monospace; font-size:1.4em; color:#ababab; font-weight:normal; clear:both; margin-top:24px; margin-bottom:8px; margin-left:32px; }
			.layout-header { border-bottom-style:solid; border-bottom-color:#222222; border-bottom-width:3px; }
			.header-right { width:136px; }
	   		.headerunlock { position:fixed; top:0; text-align:center; width:100%; padding:3px; background:#ababab; border-bottom-style:solid; border-bottom-color:#e0000e; border-bottom-width:3px; margin:0px; }
	   		.headerunlock a:link, .headerunlock a:visited { font-weight:bold; text-decoration:none; color:#ff4000; font-size:1.4em; }
	   		.headerunlock a:hover, .headerunlock a:active { font-weight:bold; text-decoration:underline; color:#ff4000; font-size:1.4em; }
	   		.headerunlockother { position:fixed; top:0; text-align:center; width:100%; padding:3px; background:#ababab; border-bottom-style:solid; border-bottom-color:#0e00e0; border-bottom-width:3px; margin:0px; }
	   		.headerunlockother a:link, .headerunlockother a:visited { font-weight:bold; text-decoration:none; color:#ff4000; font-size:1.4em; }
	   		.headerunlockother a:hover, .headerunlockother a:active { font-weight:bold; text-decoration:underline; color:#ff4000; font-size:1.4em; }
	   		.layout-footer { border-top-style:solid; border-top-color:#222222; border-top-width:3px; }
	   		.footerunlock { position:fixed; bottom:0; text-align:center; width:100%; padding:3px; background:#ababab; border-top-style:solid; border-top-color:#e0000e; border-top-width:3px; margin:0px; }
	   		.footerunlockother { position:fixed; bottom:0; text-align:center; width:100%; padding:3px; background:#ababab; border-top-style:solid; border-top-color:#0e00e0; border-top-width:3px; margin:0px; }
	   		.textListObjects { background:none; }
	   		
	   		.objectDisplayMediumLong { width:100%; }
	   		
	   		#sync { clear:both; width:100%; height:100px; }
	   		#error { color:#ffffff; font-weight:bold; }
	   		#actions, #apps, #recoveries, #authorities, #options, #help, #select, #menuSelect, #end { clear:both; padding:10px; padding-right:20px; padding-left:20px; }
	   		.optionItem, .recoveryItem, .appItem { width:98%; min-height:74px; margin:5px; margin-left:1%; margin-right:1%; padding:0; background:#ababab; text-align:left; color:#454545; }
	   		.optionLogo, .appLogo { float:left; width:64px; height:64px; margin:0; }
	   		.optionInfos, .recoveryInfos, .authorityInfos, .appInfos { padding:5px; overflow:hidden; }
	   		.optionInfos .name { margin-bottom:5px; }
	   		.optionInfos .namevalue { font-weight:bold; color:#000000; }
	   		.optionInfos .type { font-style: italic; float:right; margin-left:10px; }
	   		.optionInfos .type img { height:16px; width:16px; }
	   		.optionInfos .currentvalue { font-weight:bold; }
	   		.optionInfos .currentvaluechanged { font-weight:bold; color:#ffffff; }
	   		.optionItem .desc { clear:both; padding:5px; }
	   		.appItemList { clear:both; background:#ababab; color:#454545; margin:8px; min-height:80px; }
	   		.appLink { float:left; margin-right:8px; height:64px; width:64px; padding:8px; color:#ffffff; overflow:hidden; }
	   		.appInfos a:link, .appInfos a:visited { font-weight:normal; text-decoration:none; color:#454545; }
	   		.appInfos a:hover, .appInfos a:active { font-weight:normal; text-decoration:underline; color:#ffffff; }
	   		.appRef, .authorityID , .recoveryID{ font-size:0.6em; }
	   		.appSigner { margin-bottom:5px; }
	   		.appName, .authorityName, .recoveryName { font-weight:bold; font-size:1.4em; }
			.appShortname { font-size:1.6em; font-weight:normal; text-decoration:none; color:#ffffff; margin:0; }
	   		.appTitle { font-weight:bold; }
	   		.appActions, .recoveryActions, .authorityActions { float:right; margin-right:8px; }
	   		.appActions img { margin:3px; }
	   		.authorityItemList, .recoveryItemList { clear:both; background:#ababab; color:#454545; margin:8px; padding:0; min-height:64px; }
	   		.authorityLogo, .recoveryLogo { float:left; width:128px; height:64px; margin:0; }
	   		#helppart { clear:both; padding-top:10px }
	   		#helppart img { width:16px; height:16px; margin:0; margin:2px; margin-right:5px; }
	   		#syncallapps { margin:10px; clear:both; }
	   		#syncallapps img { margin-right:5px; }
	   		#select a:link, #select a:visited, #syncallapps a:link, #syncallapps a:visited , #help a:link, #help a:visited { color:#ababab; }
	   		#select a:hover, #select a:active, #syncallapps a:hover, #syncallapps a:active , #help a:hover, #help a:active { color:#ffffff; }
	   		#check { clear:both; padding:0; padding-top:40px; padding-bottom:20px; }
	   		
	   		#menuSelect a:link, #menuSelect a:visited { color:#454545; }
	   		#menuSelect a:hover, #menuSelect a:active { color:#ffffff; }
			.oneAction { margin:2px; padding:5px; float:left; background:#ababab; width:206px; min-height:64px; }
			@media screen and (max-height:500px) { .oneAction { padding:0; padding-top:0; padding-bottom:0; width:186px; min-height:32px; } }
			@media screen and (max-width:575px)  { .oneAction { padding:0; padding-top:0; padding-bottom:0; width:186px; min-height:32px; } }
			.oneAction-icon { float:left; margin-right:5px; }
			.oneAction-icon img { height:64px; width:64px; }
			@media screen and (max-height:500px) { .oneAction-icon img { height:32px; width:32px; } }
			@media screen and (max-width:575px)  { .oneAction-icon img { height:32px; width:32px; } }
			.oneAction-title p { font-size:1.1em; font-weight: bold; }
			
	   		input { background:#bbbbbb; color:#454545; margin:2px; border:0; box-shadow:0; padding:1px; background-origin:border-box; }
			input[type=submit] { font-weight:bold; }
			input[type=password], input[type=text], input[type=email] { padding:2px; }
	  	</style>
	</head>
	<body>
		<div class="layout-header header<?php if ($this->_unlocked) { echo 'unlock'; if ( $nebuleInstance->getCurrentEntity() != $nebuleInstance->getInstanceEntity() ) echo 'other'; } ?>">
...
?>
					...
					<form method="post" action="?<?php echo nebule::COMMAND_SELECT_ENTITY.'='.$nebuleInstance->getInstanceEntity().'&'.nebule::COMMAND_SWITCH_TO_ENTITY; ?>">
...
?>
	  	...
	  	<div class="layout-footer footer<?php if ($this->_unlocked) { echo 'unlock'; if ( $nebuleInstance->getCurrentEntity() != $nebuleInstance->getInstanceEntity() ) echo 'other'; } ?>">
	  		<div class="footer-center">
		   		<p>
			   		<?php echo $applicationName; ?><br />
			   		<?php echo $applicationVersion.' '.$applicationLevel; ?><br />
			   		(c) <?php echo $applicationLicence.' '.$applicationAuthor; ?> - <a href="<?php echo $linkApplicationWebsite; ?>" target="_blank" style="text-decoration:none;"><?php echo $applicationWebsite; ?></a>
		   		</p>
	   		</div>
		</div>
					...
					<div class="optionItem">
						...
						<div class="optionInfos">
							<div class="type"><?php echo $optionCriticality; ?>, <?php echo $optionWritableDisplay; ?>
								<img src="o/<?php echo self::DEFAULT_ICON_ALPHA_COLOR; ?>" style="background:<?php if ( $isDefault ) echo self::DEFAULT_ICON_COLOR; else echo $optionColorOnChange; ?>" />
							</div>
							<div class="name">Option <span class="namevalue"><?php echo $optionName; ?></span></div>
							<div class="type">Type <?php echo $optionType; ?></div>
							<div class="current">Current = <span class="currentvalue<?php if ( ! $isDefault ) echo 'changed'; ?>"><?php echo $optionValueDisplay; ?></span></div>
<?php
				if ( ! $isDefault )
				{
?>
...
?>
								...
								<form method="get" action="">
									<input type="hidden" name="<?php echo Action::COMMAND_OPTION_NAME; ?>" value="<?php echo $optionName; ?>">
									<input type="hidden" name="<?php echo nebule::COMMAND_SELECT_TICKET; ?>" value="<?php echo $nebuleInstance->getActionTicketValue(); ?>">
<?php
					if ( $optionType == 'string' )
					{
?>

								<input type="text" name="<?php echo Action::COMMAND_OPTION_VALUE; ?>" size="40">
<?php
					}
...
?>
								...
								<input type="hidden" name="<?php echo Action::COMMAND_OPTION_VALUE; ?>" value="<?php if ( $optionValue === false ) echo 'true'; else echo 'false'; ?>">
<?php
					}
...
?>
								...
								<input type="text" name="<?php echo Action::COMMAND_OPTION_VALUE; ?>" size="8">
<?php
					}
					else
					{
...
?>
				...
				<div id="help">
					<div id="helppart">
						<img src="o/<?php echo self::DEFAULT_ICON_ALPHA_COLOR; ?>" style="background:<?php echo self::DEFAULT_ICON_COLOR; ?>">Option have it's default value.<br />
						<img src="o/<?php echo self::DEFAULT_ICON_ALPHA_COLOR; ?>" style="background:<?php echo self::USEFUL_ICON_COLOR; ?>">Option don't have it's default value and it's useful.<br />
						<img src="o/<?php echo self::DEFAULT_ICON_ALPHA_COLOR; ?>" style="background:<?php echo self::CAREFUL_ICON_COLOR; ?>">Option don't have it's default value but it's important. Change the default value may reduce availability or stability.<br />
						<img src="o/<?php echo self::DEFAULT_ICON_ALPHA_COLOR; ?>" style="background:<?php echo self::CRITICAL_ICON_COLOR; ?>">Option don't have it's default value but it's critical for the security. Be sure it's not a error.
					</div>
					<div id="helppart">
						Type of an option can be 'string', 'boolean' or 'integer'. The type is defined by construct and can't be changed.
					</div>
					<div id="helppart">
						Status of an option can be :<br />
						- useful : it's value have to be changed for normal operation.<br />
						- carful : it's value can be changed for normal operation but be careful this may reduce availability or stability.<br />
						- critical : it's value should not be changed for normal operation, it's critical for the security. Be sure it's not a error.
					</div>
					<div id="helppart">
						...
						- locked : the option is defined as it's value can't be changed by link. It can be overridden in the local environment file.
					</div>
				</div>
<?php
	}
					...
					<div class="appItemList">
						<a href="/?<?php echo nebule::COMMAND_SWITCH_APPLICATION.'='.$application; ?>">
							<div class="appLink" style="background:<?php echo $color; ?>;">
								<span class="appShortname"><?php echo $shortName; ?></span><br /><span class="appTitle"><?php echo $title; ?></span>
							</div>
						</a>
						<div class="appInfos">
...
?>
							...
							<div class="appNoPreload">No preload by <?php $this->displayInlineObjectColorIconName(
									...
									'?'.nebule::COMMAND_SWITCH_APPLICATION.'='.self::REFERENCE_DISPLAY_APPLICATION
										.'&'.Display::DEFAULT_DISPLAY_COMMAND_MODE.'='.nebule::COMMAND_SELECT_ENTITY
										.'&'.Display::DEFAULT_DISPLAY_COMMAND_VIEW.'=default'
										.'&'.nebule::COMMAND_SELECT_ENTITY.'='.$noPreloadSigner ); ?>.</div>
<?php
			}
?>
...
?>
				...
				<div id="help">
Many differents applications can be used. The application to use can be selected from the list on <a href="?a=0">application 0</a> or here on the list.<br />
At any time you can switch to another application and come back later to the first one without losing work in progress or authentication.<br />
<br />
An application can be <?php echo $this->convertInlineIconFace(Display::DEFAULT_ICON_IOK).'enabled'; ?> or <?php echo $this->convertInlineIconFace(Display::DEFAULT_ICON_IERR).'disabled'; ?>.<br />
To be usable, each application have to be enabled on the list here. Without activation, the bootstrap refuse to load an application.<br />
...
<br />
All applications can be <?php echo $this->convertInlineIconFace(Display::DEFAULT_ICON_SYNOBJ).'synchronized'; ?> to get last updates.<br />
Synchronization must be enabled with the option <i>permitSynchronizeApplication</i> and if needed with the option <i>permitPublicSynchronizeApplication</i>.<br />
<br />
Each application is declared by the <a href="http://code.master.nebule.org">code master</a> or by a local authority and can be updated by a local authority.<br />
On first loading of an application, a preload permit to enhance the user experience. The preload can be disabled for an application by the code master or by a local authority.
				</div>
<?php
	}
