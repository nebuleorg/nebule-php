...
em+rom6wKFdFizkPY2qb/0/37a/uVxnfd5/wWNcHiC0uUMVAAAAABJRU5ErkJggg==';
    ...
    private function _displayMetrology()
    {
		...
		echo "<br />\n";*/
                    ...
                    $this->_traductionInstance->echoTranslate('Le serveur à pris %01.4fs pour calculer la page.', $qantion_time_total);
                    echo ' (';
                    foreach ($qantionTimeList as $time) {
                        echo sprintf(" %1.4fs", $time);
                    }
...
class ModuleHelp extends Modules
{
    ...
    protected $MODULE_LICENCE = '(c) GLPv3 nebule 2019-2023';
    ...
    private function _displayHlpHelp()
    {
        ...
        <div class="text">
            <p>
                <?php $this->_applicationInstance->getTranslateInstance()->echoTranslate('::qantion:module:help:AideGenerale:Text') ?>
            </p>
        </div>
        <?php
    }
    ...
    private function _displayHlpAbout(): void
    {
        ...
        <div class="text">
            <p>
                <?php $this->_applicationInstance->getTranslateInstance()->echoTranslate('::qantion:module:help:APropos:Text') ?>
            </p>
            <p>
                <?php $this->_applicationInstance->getTranslateInstance()->echoTranslate('::qantion:module:help:APropos:Liens') ?>
            </p>
        </div>
        <?php
...
class ModuleAdmin extends Modules
{
        ...
        if ($this->_unlocked) {
            ...
            foreach ($listEntities as $instance) {
                ...
                $list[$i]['htlink'] = '?' . Displays::DEFAULT_DISPLAY_COMMAND_MODE . '=' . $this->_applicationInstance->getModule('ModuleEntities')->getCommandName()
                    . '&' . Displays::DEFAULT_DISPLAY_COMMAND_VIEW . '=' . \Nebule\Application\Qantion\ModuleEntities::MODULE_DEFAULT_VIEW
            ...
            if (sizeof($list) != 0) {
                ...
                $this->_applicationInstance->getDisplayInstance()->displayMessageInformation_DEPRECATED('::qantion:module:admin:Display:NoLocalAuthority');
            }
    ...
    private function _displayInlineRecoveryEntities(): void
    {
        ...
        if (sizeof($list) != 0) {
            ...
            $this->_applicationInstance->getDisplayInstance()->displayMessageInformation_DEPRECATED('::qantion:module:admin:Display:NoRecoveryEntity');
        }
        unset($list, $listEntities);
    }
        ...
        switch ($hookName) {
            case 'selfMenu':
                ...
                if ($this->_displayInstance->getCurrentDisplayView() == $this->MODULE_REGISTERED_VIEWS[6]
                    ...
                    $hookArray[$arraySeed]['link'] = '?' . Displays::DEFAULT_DISPLAY_COMMAND_MODE . '=' . $this->MODULE_COMMAND_NAME
                        . '&' . Displays::DEFAULT_DISPLAY_COMMAND_VIEW . '=' . $this->MODULE_REGISTERED_VIEWS[3]
                        . '&' . References::COMMAND_SELECT_CURRENCY . '=' . $this->_nebuleInstance->getCurrentCurrency();
                }
                ...
                if ($this->_displayInstance->getCurrentDisplayView() == $this->MODULE_REGISTERED_VIEWS[6]) {
                    ...
                    $hookArray[$arraySeed]['desc'] = '';
                    $hookArray[$arraySeed]['link'] = '?' . Displays::DEFAULT_DISPLAY_COMMAND_MODE . '=' . $this->MODULE_COMMAND_NAME
                        . '&' . Displays::DEFAULT_DISPLAY_COMMAND_VIEW . '=' . $this->MODULE_REGISTERED_VIEWS[15]
                        . '&' . References::COMMAND_SELECT_CURRENCY . '=' . $this->_nebuleInstance->getCurrentCurrency();
                }
                ...
                if ($this->_displayInstance->getCurrentDisplayView() == $this->MODULE_REGISTERED_VIEWS[9]
                    ...
                    $hookArray[$arraySeed]['link'] = '?' . Displays::DEFAULT_DISPLAY_COMMAND_MODE . '=' . $this->MODULE_COMMAND_NAME
                        . '&' . Displays::DEFAULT_DISPLAY_COMMAND_VIEW . '=' . $this->MODULE_REGISTERED_VIEWS[8]
                        . '&' . References::COMMAND_SELECT_TOKENPOOL . '=' . $this->_nebuleInstance->getCurrentTokenPool()
                        . '&' . References::COMMAND_SELECT_CURRENCY . '=' . $this->_nebuleInstance->getCurrentCurrency();
                }
                ...
                if ($this->_displayInstance->getCurrentDisplayView() == $this->MODULE_REGISTERED_VIEWS[14]
                    ...
                    $hookArray[$arraySeed]['link'] = '?' . Displays::DEFAULT_DISPLAY_COMMAND_MODE . '=' . $this->MODULE_COMMAND_NAME
                        ...
                        . '&' . References::COMMAND_SELECT_TOKEN . '=' . $this->_nebuleInstance->getCurrentToken()
                        . '&' . References::COMMAND_SELECT_TOKENPOOL . '=' . $this->_nebuleInstance->getCurrentTokenPool()
                        . '&' . References::COMMAND_SELECT_CURRENCY . '=' . $this->_nebuleInstance->getCurrentCurrency();
                }
            ...
            case 'selfCreateCurrenty';
                ...
                if ($this->_configurationInstance->getOptionAsBoolean('permitWrite')
                    ...
                    $hookArray[$arraySeed]['link'] = '?' . Displays::DEFAULT_DISPLAY_COMMAND_MODE . '=' . $this->MODULE_COMMAND_NAME
                        . '&' . Displays::DEFAULT_DISPLAY_COMMAND_VIEW . '=' . $this->MODULE_REGISTERED_VIEWS[5]
                        . '&' . References::COMMAND_SELECT_CURRENCY . '=' . $object;
                }
                break;
...
//			case 'selfMenuEntity':
            ...
            case 'selfMenuTokenPool';
                ...
                $hookArray[$arraySeed]['link'] = '?' . Displays::DEFAULT_DISPLAY_COMMAND_MODE . '=' . $this->MODULE_COMMAND_NAME
                    . '&' . Displays::DEFAULT_DISPLAY_COMMAND_VIEW . '=' . $this->MODULE_REGISTERED_VIEWS[8]
                    . '&' . References::COMMAND_SELECT_TOKENPOOL . '=' . $object
                    . '&' . References::COMMAND_SELECT_CURRENCY . '=0';
                break;
            ...
            case 'selfMenuToken';
                ...
                $hookArray[$arraySeed]['link'] = '?' . Displays::DEFAULT_DISPLAY_COMMAND_MODE . '=' . $this->MODULE_COMMAND_NAME
                    . '&' . Displays::DEFAULT_DISPLAY_COMMAND_VIEW . '=' . $this->MODULE_REGISTERED_VIEWS[13]
                    . '&' . References::COMMAND_SELECT_TOKEN . '=' . $object
                    . '&' . References::COMMAND_SELECT_TOKENPOOL . '=0'
                    . '&' . References::COMMAND_SELECT_CURRENCY . '=0';
                break;
        }
        return $hookArray;
    ...
    private function _displayHeader(): void
    {
        if ($this->_configurationInstance->getOptionAsBoolean('permitWrite')
            ...
            if ($this->_applicationInstance->getActionInstance()->getCreateCurrency()) {
                // Affiche le titre.
                echo $this->_displayInstance->getDisplayTitle_DEPRECATED('::sylabe:module:qantion:CreateCurrency', $this->MODULE_LOGO, false);
                ...
                if (!$createPoolError) {
                    ...
                    if (is_a($instance, 'Currency')
                        ...
                        $list[0]['param'] = array(
                            ...
                            'link2Object' => '?' . Displays::DEFAULT_DISPLAY_COMMAND_MODE . '=' . $this->MODULE_COMMAND_NAME
                                . '&' . Displays::DEFAULT_DISPLAY_COMMAND_VIEW . '=' . $this->MODULE_REGISTERED_VIEWS[3]
                                . '&' . References::COMMAND_SELECT_CURRENCY . '=' . $instance->getID(),
                    ...
                    echo $this->_displayInstance->getDisplayInformation_DEPRECATED('::sylabe:module:qantion:create:notOKCreation', $param);
                }
            }
            ...
            if ($this->_applicationInstance->getActionInstance()->getCreateTokenPool()) {
                // Affiche le titre.
                echo $this->_displayInstance->getDisplayTitle_DEPRECATED('::sylabe:module:qantion:CreatePool', $this->MODULE_REGISTERED_ICONS[0], false);
                ...
                if (!$createPoolError) {
                    ...
                    if (is_a($instance, 'TokenPool')
                        ...
                        $list[0]['param'] = array(
                            ...
                            'link2Object' => '?' . Displays::DEFAULT_DISPLAY_COMMAND_MODE . '=' . $this->MODULE_COMMAND_NAME
                                . '&' . Displays::DEFAULT_DISPLAY_COMMAND_VIEW . '=' . $this->MODULE_REGISTERED_VIEWS[8]
                                . '&' . References::COMMAND_SELECT_TOKENPOOL . '=' . $instance->getID()
                                . '&' . References::COMMAND_SELECT_CURRENCY . '=' . $instance->getParam('CID'),
            ...
            if ($this->_applicationInstance->getActionInstance()->getCreateTokens()) {
                // Affiche le titre.
                echo $this->_displayInstance->getDisplayTitle_DEPRECATED('::sylabe:module:qantion:CreateTokens', $this->MODULE_REGISTERED_ICONS[0], false);
                    ...
                    foreach ($instances as $instance) {
                        if (is_a($instance, 'Token')
                            ...
                            $list[$i]['param'] = array(
                                ...
                                'displaySize' => 'small',
                                'displayRatio' => 'short',
                                'objectRefs' => $this->getTranslateInstance('::sylabe:module:qantion:Token'),
                                'link2Object' => '?' . Displays::DEFAULT_DISPLAY_COMMAND_MODE . '=' . $this->MODULE_COMMAND_NAME
                                    . '&' . Displays::DEFAULT_DISPLAY_COMMAND_VIEW . '=' . $this->MODULE_REGISTERED_VIEWS[13]
                                    . '&' . References::COMMAND_SELECT_TOKEN . '=' . $instance->getID()
                                    . '&' . References::COMMAND_SELECT_TOKENPOOL . '=' . $instance->getParam('PID')
                                    . '&' . References::COMMAND_SELECT_CURRENCY . '=' . $instance->getParam('CID'),
    ...
    {
        // Affiche le titre.
        echo $this->_displayInstance->getDisplayTitle_DEPRECATED('::sylabe:module:qantion:MyList', $this->MODULE_LOGO, false);
     ...
     * @return void
     */
    private function _displayCommonInlineList($links): void
    {
        $list = array();
        $i = 0;
        $instance = null;
        ...
        foreach ($links as $link) {
            ...
            if (!isset($listOkObjects[$link->getParsed()['bl/rl/nid1']])
                ...
                $list[$i]['param'] = array(
                    ...
                    'link2Object' => '?' . Displays::DEFAULT_DISPLAY_COMMAND_MODE . '=' . $this->MODULE_COMMAND_NAME
                        . '&' . Displays::DEFAULT_DISPLAY_COMMAND_VIEW . '=' . $this->MODULE_REGISTERED_VIEWS[3]
                        . '&' . References::COMMAND_SELECT_CURRENCY . '=' . $link->getParsed()['bl/rl/nid1'],
                    'objectIcon' => $this->MODULE_REGISTERED_ICONS[3],
            ...
            // Marque comme vu.
            $listOkObjects[$link->getParsed()['bl/rl/nid1']] = true;
        }
    ...
    {
        // Affiche le titre.
        echo $this->_displayInstance->getDisplayTitle_DEPRECATED('::sylabe:module:qantion:ListAll', $this->MODULE_LOGO, false);
    ...
    {
        // Affiche le titre.
        echo $this->_displayInstance->getDisplayTitle_DEPRECATED('::sylabe:module:qantion:Find', $this->MODULE_LOGO, false);
     ...
     * @return void
     */
    private function _display_InlineFindCurrency(): void
    {
        // @todo
        $param = array(
            'enableDisplayIcon' => true,
     ...
     * @return void
     */
    private function _displayCreateCurrency(): void
    {
     ...
     * @return void
     */
    private function _displayCreatePool(): void
    {
     ...
     * @desc 020200308
     */
    private function _displayCreateCommonItem($type, $update = false): void
    {
        ...
        if ($this->_configurationInstance->getOptionAsBoolean('permitWrite')
            ...
            // Affiche le titre.
            echo $this->_displayInstance->getDisplayTitle_DEPRECATED($title, $icon, false);
            ...
            <div class="layoutObjectsList">
                <div class="objectsListContent">
                    <form enctype="multipart/form-data" method="post"
                          action="<?php echo '?' . Displays::DEFAULT_DISPLAY_COMMAND_MODE . '=' . $this->MODULE_COMMAND_NAME
                              . '&' . Displays::DEFAULT_DISPLAY_COMMAND_VIEW . '=' . $view
                              . '&' . $action
                              . $this->_nebuleInstance->getTicketingInstance()->getActionTicketValue(); ?>" style="padding-left:5px;">
                            ...
                            if (($type == 'currency' || $type == 'pool')
                                ...
                                foreach ($links as $link) {
                                    ...
                                    if (!isset($okselected[$link->getParsed()['bl/rl/nid1']])
                                        ...
                                        $okselected[$link->getParsed()['bl/rl/nid1']] = $link->getParsed()['bl/rl/nid1'];
                                        $property['checkbox'] .= ' ' . $link->getParsed()['bl/rl/nid1'];
                                    }
                                }
    ...
    {
        // Affiche le titre.
        echo $this->_displayInstance->getDisplayTitle_DEPRECATED('::sylabe:module:qantion:Admin', $this->MODULE_LOGO, false);
     ...
     * @return void
     */
    private function _display_InlineAdminCurrency(): void
    {
        // @todo
        $param = array(
            'enableDisplayIcon' => true,
     ...
     * @return void
     */
    private function _display_InlineAdminToken(): void
    {
        // @todo
        $param = array(
            'enableDisplayIcon' => true,
    ...
    {
        // Affiche le titre.
        echo $this->_displayInstance->getDisplayTitle_DEPRECATED('::sylabe:module:qantion:AllPools', $this->MODULE_LOGO, false);
     ...
     * @return void
     */
    private function _display_InlineListPools(): void
    {
        // Lit les liens vers les monnaies.
    ...
    {
        // Affiche le titre.
        echo $this->_displayInstance->getDisplayTitle_DEPRECATED('::sylabe:module:qantion:Currency', $this->MODULE_REGISTERED_ICONS[3], false);

        $this->_applicationInstance->getDisplayInstance()->registerInlineContentID('dispcurrency');

        // Affiche le titre.
        echo $this->_displayInstance->getDisplayTitle_DEPRECATED('::sylabe:module:qantion:RelativeValue', $this->MODULE_REGISTERED_ICONS[6], false);
     ...
     * @return void
     */
    private function _display_InlineDispCurrency(): void
    {
        ...
        if ($instance->getID() != $this->_nebuleInstance->getCurrentCurrency()
            ...
            echo $this->_displayInstance->getDisplayInformation_DEPRECATED('::sylabe:module:qantion:WarnInvalid', $param);
        }
    ...
    {
        // Affiche le titre.
        echo $this->_displayInstance->getDisplayTitle_DEPRECATED('::sylabe:module:qantion:DisplayPool', $this->MODULE_REGISTERED_ICONS[4], false);
     ...
     * @return void
     */
    private function _display_InlineDispPool(): void
    {
        $value = $this->_applicationInstance->getDisplayInstance()->getInlineContentID();
    ...
    {
        // Affiche le titre.
        echo $this->_displayInstance->getDisplayTitle_DEPRECATED('::sylabe:module:qantion:DisplayToken', $this->MODULE_REGISTERED_ICONS[5], false);
     ...
     * @return void
     */
    private function _display_InlineDispToken(): void
    {
        $value = $this->_applicationInstance->getDisplayInstance()->getInlineContentID();
    ...
    private function _displayDescCurrency(): void
    {
        ...
        // Affiche le titre.
        echo $this->_displayInstance->getDisplayTitle_DEPRECATED('::sylabe:module:qantion:Desc', $this->MODULE_REGISTERED_ICONS[6], false);
     ...
     * @return void
     */
    private function _display_InlineDescCurrency(): void
    {
        $value = $this->_applicationInstance->getDisplayInstance()->getInlineContentID();
     ...
     * @return void
     */
    private function _display_InlineDescCommonDisp($instance, $enableDisplayJS = true): void
    {
        // Détermine le type.
        $type1 = '';
        ...
        if ((get_class($instance) == 'TokenPool'
            ...
            $link = '?' . Displays::DEFAULT_DISPLAY_COMMAND_MODE . '=' . $this->MODULE_COMMAND_NAME
                . '&' . Displays::DEFAULT_DISPLAY_COMMAND_VIEW . '=' . $this->MODULE_REGISTERED_VIEWS[3]
                . '&' . References::COMMAND_SELECT_CURRENCY . '=' . $currencyInstance->getID();
            $icon = $this->MODULE_REGISTERED_ICONS[3];
            $refInstance = $this->_nebuleInstance->newEntity($instance->getParam('AID'));
     ...
     * @return void
     */
    private function _display_InlineDescCommonDesc($instance): void
    {
        // Détermine le type.
        $type1 = '';
        $type2 = '';
     ...
     * @return void
     */
    private function _display_InlineDescCommonValue($instance): void
    {
        $list = array();
...
//		$this->_applicationInstance->getDisplayInstance()->registerInlineContentID('descpooltokens');
     ...
     * @return void
     */
    private function _display_InlineDescPool(): void
    {
        $value = $this->_applicationInstance->getDisplayInstance()->getInlineContentID();
     ...
     * @return void
     */
    private function _display_InlineDescToken(): void
    {
        $value = $this->_applicationInstance->getDisplayInstance()->getInlineContentID();
    ...
    {
        // Affiche le titre.
        echo $this->_displayInstance->getDisplayTitle_DEPRECATED('::sylabe:module:qantion:Delete', $this->MODULE_REGISTERED_ICONS[3], false);
        ...
        if ($this->_configurationInstance->getOptionAsBoolean('permitWrite')
            ...
            if ($this->_nebuleInstance->getCurrentCurrency() != '0') {
                ...
                echo $this->_displayInstance->getDisplayInformation_DEPRECATED('::sylabe:module:qantion:DeleteWarn', $param);
    ...
    {
        // Affiche le titre.
        echo $this->_displayInstance->getDisplayTitle_DEPRECATED('::sylabe:module:qantion:Delete', $this->MODULE_REGISTERED_ICONS[4], false);
        ...
        if ($this->_configurationInstance->getOptionAsBoolean('permitWrite')
            ...
            if ($this->_nebuleInstance->getCurrentTokenPool() != '0') {
                $dispHook = array(
                    ...
                    'link' => '/?' . Displays::DEFAULT_DISPLAY_COMMAND_MODE . '=' . $this->MODULE_COMMAND_NAME
                        . '&' . Displays::DEFAULT_DISPLAY_COMMAND_VIEW . '=' . $this->MODULE_REGISTERED_VIEWS[9]
                        . '&' . References::COMMAND_SELECT_CURRENCY . '=' . $this->_nebuleInstance->getCurrentTokenPool(),
                );
                echo $this->_displayInstance->getDisplayHookAction($dispHook, true, 'MediumShort');
    ...
    {
        // Affiche le titre.
        echo $this->_displayInstance->getDisplayTitle_DEPRECATED('::sylabe:module:qantion:Delete', $this->MODULE_REGISTERED_ICONS[5], false);
        ...
        if ($this->_configurationInstance->getOptionAsBoolean('permitWrite')
            ...
            if ($this->_nebuleInstance->getCurrentToken() != '0') {
                $dispHook = array(
                    ...
                    'link' => '/?' . Displays::DEFAULT_DISPLAY_COMMAND_MODE . '=' . $this->MODULE_COMMAND_NAME
                        . '&' . Displays::DEFAULT_DISPLAY_COMMAND_VIEW . '=' . $this->MODULE_REGISTERED_VIEWS[14]
                        . '&' . References::COMMAND_SELECT_CURRENCY . '=' . $this->_nebuleInstance->getCurrentToken(),
                );
                echo $this->_displayInstance->getDisplayHookAction($dispHook, true, 'MediumShort');
    ...
    private function _displayItemsCurrency(): void
    {
        ...
        // Affiche le titre.
        echo $this->_displayInstance->getDisplayTitle_DEPRECATED('::sylabe:module:qantion:AllPools', $this->MODULE_REGISTERED_ICONS[4], false);
     ...
     * @return void
     */
    private function _display_InlineItemsCurrency(): void
    {
        $value = $this->_applicationInstance->getDisplayInstance()->getInlineContentID();
     ...
     * @return void
     */
    private function _display_InlineDescCommonItems($instance): void
    {
        // Détermine le type.
        $type1 = '';
        if (get_class($instance) == 'Currency') {
        ...
        foreach ($items as $item) {
            if ($type1 == 'Currency') {
                ...
                $link = '?' . Displays::DEFAULT_DISPLAY_COMMAND_MODE . '=' . $this->MODULE_COMMAND_NAME
                    . '&' . Displays::DEFAULT_DISPLAY_COMMAND_VIEW . '=' . $this->MODULE_REGISTERED_VIEWS[8]
                    . '&' . References::COMMAND_SELECT_TOKENPOOL . '=' . $instanceItem->getID()
                    . '&' . References::COMMAND_SELECT_CURRENCY . '=' . $instance->getID();
                ...
                $link = '?' . Displays::DEFAULT_DISPLAY_COMMAND_MODE . '=' . $this->MODULE_COMMAND_NAME
                    . '&' . Displays::DEFAULT_DISPLAY_COMMAND_VIEW . '=' . $this->MODULE_REGISTERED_VIEWS[13]
                    . '&' . References::COMMAND_SELECT_TOKEN . '=' . $instanceItem->getID()
                    . '&' . References::COMMAND_SELECT_TOKENPOOL . '=' . $instance->getID()
                    . '&' . References::COMMAND_SELECT_CURRENCY . '=' . $instanceItem->getParam('CID');
            } else {
                continue;
            }
            ...
            if ($instanceItem->getID() != '0') {
                ...
                $list[$i]['param'] = array(
                    ...
                    'displaySize' => 'small',
                    'displayRatio' => 'short',
                    'objectRefs' => $this->getTranslateInstance('::sylabe:module:qantion:' . $subtype),
                    'link2Object' => $link,
                    'objectIcon' => $icon,
    ...
    private function _displayItemsPool(): void
    {
        ...
        // Affiche le titre.
        echo $this->_displayInstance->getDisplayTitle_DEPRECATED('::sylabe:module:qantion:AllTokens', $this->MODULE_REGISTERED_ICONS[5], false);
        $this->_applicationInstance->getDisplayInstance()->registerInlineContentID('descpooltokens');
     ...
     * @return void
     */
    private function _display_InlineItemsPool(): void
    {
        $value = $this->_applicationInstance->getDisplayInstance()->getInlineContentID();
     ...
     * @return array
     */
    private function _getCurrencies($entity = ''): array
    {
        $result = array();
        ...
        if ($entity == 'myself') {
            $entity = $this->_applicationInstance->getCurrentEntityID();
        }
     ...
     * @return boolean
     */
    private function _isCurrency($object, $entity = ''): bool
    {
        // Prépare l'objet.
        $object = $this->_nebuleInstance->convertIdToTypedObjectInstance($object);
     ...
     * @return array
     */
    private function _getByIsCurrency($object): array
    {
        $result = array();
        $okEntity = array();
        ...
        // Extrait les entités.
        foreach ($links as $link) {
            if (!isset($okEntity[$link->getParsed()['bs/rs1/eid']])) {
                $result[] = $link->getParsed()['bs/rs1/eid'];
                $okEntity[$link->getParsed()['bs/rs1/eid']] = true;
            }
        }
     ...
     * @return array
     */
    private function _getPools($entity = ''): array
    {
        $result = array();
     ...
     * @return boolean
     */
    private function _isPool($object, $entity = ''): bool
    {
        // Prépare l'objet.
        $object = $this->_nebuleInstance->convertIdToTypedObjectInstance($object);
     ...
     * @return array
     */
    private function _getByIsPool($object): array
    {
        $result = array();
        $okEntity = array();
     ...
     * @return string
     */
    private function _stringFilter($value, $limit = 1024): string
    {
        if ($value == '') {
            return '';
        }
