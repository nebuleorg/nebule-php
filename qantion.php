...
?>
		...
		<style type="text/css">
			...
			.qantionMenuListContentActionModules { background:rgba(0,0,0,0.5); color:#ffffff; }
			.qantionMenuListContentActionHooks { background:rgba(255,255,255,0.66); }
...
//			case 'selfMenuEntity':
	...
	public function display()
	{
		...
		switch ( $this->_display->getCurrentDisplayView() )
		{
			case $this->MODULE_REGISTERED_VIEWS[0]:		$this->_displayList();				break;
			case $this->MODULE_REGISTERED_VIEWS[1]:		$this->_displayListAll();			break;
			case $this->MODULE_REGISTERED_VIEWS[2]:		$this->_displayFindCurrency();		break;
			case $this->MODULE_REGISTERED_VIEWS[3]:		$this->_displayDispCurrency();		break;
			case $this->MODULE_REGISTERED_VIEWS[4]:		$this->_displayCreateCurrency();	break;
			case $this->MODULE_REGISTERED_VIEWS[5]:		$this->_displayCreatePool();		break;
			case $this->MODULE_REGISTERED_VIEWS[6]:		$this->_displayAdminCurrency();		break;
			case $this->MODULE_REGISTERED_VIEWS[7]:		$this->_displayListPools();			break;
			case $this->MODULE_REGISTERED_VIEWS[8]:		$this->_displayDispPool();			break;
			case $this->MODULE_REGISTERED_VIEWS[9]:		$this->_displayAdminPool();			break;
			case $this->MODULE_REGISTERED_VIEWS[10]:	$this->_displayDescCurrency();		break;
			case $this->MODULE_REGISTERED_VIEWS[11]:	$this->_displayDescPool();			break;
			case $this->MODULE_REGISTERED_VIEWS[12]:	$this->_displayDescToken();			break;
			case $this->MODULE_REGISTERED_VIEWS[13]:	$this->_displayDispToken();			break;
			case $this->MODULE_REGISTERED_VIEWS[14]:	$this->_displayAdminToken();		break;
			case $this->MODULE_REGISTERED_VIEWS[15]:	$this->_displayDeleteCurrency();	break;
			case $this->MODULE_REGISTERED_VIEWS[16]:	$this->_displayDeletePool();		break;
			case $this->MODULE_REGISTERED_VIEWS[17]:	$this->_displayDeleteToken();		break;
			case $this->MODULE_REGISTERED_VIEWS[18]:	$this->_displayItemsCurrency();		break;
			case $this->MODULE_REGISTERED_VIEWS[19]:	$this->_displayItemsPool();			break;
			default:									$this->_displayList();				break;
		}
	}
	...
	public function displayInline()
	{
		switch ( $this->_display->getCurrentDisplayView() )
		{
			case $this->MODULE_REGISTERED_VIEWS[0]:		$this->_display_InlineList();			break;
			case $this->MODULE_REGISTERED_VIEWS[1]:		$this->_display_InlineListAll();		break;
			case $this->MODULE_REGISTERED_VIEWS[2]:		$this->_display_InlineFindCurrency();	break;
			case $this->MODULE_REGISTERED_VIEWS[3]:		$this->_display_InlineDispCurrency();	break;
			case $this->MODULE_REGISTERED_VIEWS[6]:		$this->_display_InlineAdminCurrency();	break;
			case $this->MODULE_REGISTERED_VIEWS[7]:		$this->_display_InlineListPools();		break;
			case $this->MODULE_REGISTERED_VIEWS[8]:		$this->_display_InlineDispPool();		break;
			case $this->MODULE_REGISTERED_VIEWS[9]:		$this->_display_InlineAdminPool();		break;
			case $this->MODULE_REGISTERED_VIEWS[10]:	$this->_display_InlineDescCurrency();	break;
			case $this->MODULE_REGISTERED_VIEWS[11]:	$this->_display_InlineDescPool();		break;
			case $this->MODULE_REGISTERED_VIEWS[12]:	$this->_display_InlineDescToken();		break;
			case $this->MODULE_REGISTERED_VIEWS[13]:	$this->_display_InlineDispToken();		break;
			case $this->MODULE_REGISTERED_VIEWS[14]:	$this->_display_InlineAdminToken();		break;
			case $this->MODULE_REGISTERED_VIEWS[18]:	$this->_display_InlineItemsCurrency();	break;
			case $this->MODULE_REGISTERED_VIEWS[19]:	$this->_display_InlineItemsPool();		break;
			default:									$this->_display_InlineList();			break;
		}
	}
	 ...
	 * 
	 * Si $update à true, cela permet de modifier un objet existant. @todo remplir les valeurs.
	 *
	 * @desc 020200308
	 * @param $type string
...
?>
		...
		<div class="objectsListContent">
			<form enctype="multipart/form-data" method="post" action="<?php echo '?'.Display::DEFAULT_DISPLAY_COMMAND_MODE.'='.$this->MODULE_COMMAND_NAME
