...
class App8 extends App0
{
    ...
    {
        $this->_metrologyInstance->log_reopen('app8');
        $this->_metrologyInstance->addLog('Loading', Metrology::LOG_LEVEL_NORMAL, __METHOD__, '2067738b');

        echo 'CHK';
        ob_end_clean();

        $this->_htmlHeader('app 8');
        $this->_htmlTop();
