...
class Configuration extends Functions
{
    ...
    const OPTIONS_DESCRIPTION = array(
        ...
        'permitActAsMaster' => 'Allow an entity to become and act as master of this server instance. This permit to create a new puppetmaster.',
        ...
        'linkMaxUIDbyRL' => 'Maximum UIDs of links that can be read on the registry RL. If more, link is marked to have invalid structure.',
    ...
    const GROUP_ACTIONS_PERMIT = array(
        ...
        'GroupCreateEntityAction' => ['permitWrite','permitWriteLink','permitWriteObject','permitWriteEntity','token'],
        'GroupCreateEntity' => ['permitWrite','permitWriteLink','permitWriteObject','permitWriteEntity'],
        'GroupCreateGroupAction' => ['unlocked','permitWrite','permitWriteLink','permitWriteObject','permitWriteGroup','token'],
        ...
        'GroupCreateConversationAction' => ['unlocked','permitWrite','permitWriteLink','permitWriteObject','permitWriteGroup','permitWriteConversation','token'],
        'GroupCreateConversation' => ['unlocked','permitWrite','permitWriteLink','permitWriteObject','permitWriteGroup','permitWriteConversation'],
        'GroupDeleteConversation' => ['unlocked','permitWrite','permitWriteLink','permitWriteGroup','permitWriteConversation'],
