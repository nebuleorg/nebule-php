...
<ul>
    <?php
    $options = $this->_nebuleInstance->getConfigurationInstance()->getListOptions();
    $categories = $this->_nebuleInstance->getConfigurationInstance()->getListCategoriesOptions();
    $optionsCategorie = $this->_nebuleInstance->getConfigurationInstance()->getListOptionsCategory();
    $optionsType = $this->_nebuleInstance->getConfigurationInstance()->getListOptionsType();
    $optionsWriteable = $this->_nebuleInstance->getConfigurationInstance()->getListOptionsWritable();
    $optionsDefaultValue = $this->_nebuleInstance->getConfigurationInstance()->getListOptionsDefaultValue();
    $optionsCriticality = $this->_nebuleInstance->getConfigurationInstance()->getListOptionsCriticality();
    $optionsDescription = $this->_nebuleInstance->getConfigurationInstance()->getListOptionsDescription();
    foreach ( $categories as $categorie )
    {
        echo "\t<li>Catégorie '<code>".$categorie."</code>' :\n\t\t<ul>\n";
        foreach ( $options as $option )
        {
            if ( $optionsCategorie[$option] == $categorie )
            {
