...
class App7 extends App0
{
    ...
    {
        $this->_metrologyInstance->log_reopen('app7');
        $this->_metrologyInstance->addLog('Loading', Metrology::LOG_LEVEL_NORMAL, __METHOD__, '30344086');

        echo 'CHK';
        ob_end_clean();

        $this->_htmlHeader('app 7');
        $this->_htmlTop();
