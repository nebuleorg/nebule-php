...
class Application extends Applications implements applicationInterface
{
    ...
    const APPLICATION_VERSION = '020231229';
...
class ModuleHelp extends Modules
{
    ...
    private function _displayHlpAbout(): void
    {
        ...
        $list[1]['param'] = $param;
        $list[2]['information'] = $this->_applicationInstance->getTraductionInstance()->getTraduction('::Version') . ' : ' . Application::APPLICATION_VERSION;
        $list[2]['param'] = $param;
