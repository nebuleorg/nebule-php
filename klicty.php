...
Nfpq7EizdAdFUfYz0yz9LTvN7fKGAPhH0DmLH0x8vVVWLBYrxWLxVJTQjY+mGgAaABoAGgDOsv0NZwFCCJnLgSUAAAAASUVORK5CYII=";
    ...
    const DEFAULT_APPLICATION_LOGO_LINK = '?dv=about';
        ...
        if ($this->_configurationInstance->getOptionAsBoolean('permitWrite')
            ...
            if ($this->_applicationInstance->getActionInstance()->getInstanceActionsObjects()->getUploadObject()) {
                ...
                if (!$this->_applicationInstance->getActionInstance()->getInstanceActionsObjects()->getUploadObjectError()) {
                        ...
                        <div class="oneActionItem" id="selfEntity">
                            <div class="oneActionItem-top">
                                ...
                                <div class="oneAction-entityname">
                                    <p><?php $this->displayInlineObjectColorIconName($this->_entitiesInstance->getGhostEntityInstance()); ?></p>
                                </div>
                    ...
                    <div class="text">
                        <p>
                            (<?php echo $this->_applicationInstance->getActionInstance()->getInstanceActionsObjects()->getUploadObjectErrorMessage(); ?>
                            )
                        </p>
                    </div>
                    <?php
            ...
            <div class="text">
                <form enctype="multipart/form-data" method="post"
                    ...
                    <div class="floatRight textAlignRight">
                        ...
                        :
                        <select
                                name="<?php echo ActionsObjects::DEFAULT_COMMAND_ACTION_UPLOAD_FILE_LIFETIME; ?>"
                                class="klictyInput">
                            <option value="1h">
...
<?php					<select
    ...
    private function _displayContentAuth(): void
    {
        ...
        echo $this->_applicationInstance->getDisplayInstance()->getDisplayObject_DEPRECATED($this->_entitiesInstance->getGhostEntityInstance(), $param);
        echo '</div>' . "\n";
        echo '</div>' . "\n";
        ...
        if ($idCheck != 'Error') {
            if ($this->_entitiesInstance->getGhostEntityInstance()->getHavePrivateKeyPassword()
                ...
                echo $this->_applicationInstance->getDisplayInstance()->getDisplayObject_DEPRECATED($this->_entitiesInstance->getGhostEntityPrivateKeyInstance(), $param);
                echo '</div>' . "\n";
                echo '</div>' . "\n";
...
class Action extends Actions
{
    ...
    protected function _actionUploadFile(): void
    {
        ...
        if ($this->_configurationInstance->getOptionAsBoolean('permitWrite')
            ...
            $date = date(DATE_ATOM);
            $signer = $this->_entitiesInstance->getGhostEntityInstance();
            ...
            if ($this->_actionUploadFileType != '') {
                ...
                if ($textID !== false) {
                    ...
                    $this->_createLink($signer, $action, $source, $target, $meta, $this->_actionUploadFileObfuscateLinks);
                }
            }
            ...
            if ($this->_actionUploadFileLifeTime != '') {
                ...
                if ($textID !== false) {
                    ...
                    $target = $textID;
                    $meta = $this->getNidFromData(Application::APPLICATION_EXPIRATION_DATE);
                    $this->_createLink($signer, $action, $source, $target, $meta, false);
                }
            }
