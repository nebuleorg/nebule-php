...
<?php					<select
    ...
    private function _displayContentAuth()
    {
        ...
        if ($idCheck != 'Ok') {
            ...
            echo $this->_applicationInstance->getDisplayInstance()->getDisplayObjectsList_DEPRECATED($list, 'small');
        } else {
            $param = array(
                'enableDisplayIcon' => true,
                'enableDisplayAlone' => true,
...
Le projet klicty permet un accès à cette nouvelle façon de gérer nos informations sans remettre en question fondamentalement l’organisation et notamment les systèmes d’exploitation de notre système d’information.<br />
<br />
L’interface klicty est une page web destinée à être mise en place sur un serveur pour manipuler des objets et des liens.
...
<br />
Le projet klicty reproduit la concentration des données vers des serveurs sur l’Internet.
Il est nativement prévu pour pouvoir être implanté sur n’importe quel serveur web.
Et, se basant sur les principes de nebule, tout serveur hébergeant klicty peut nativement :<br />
...
Chacun peut ainsi mettre en place simplement klicty chez lui, ou continuer à l’utiliser sur un autre serveur de l’Internet.
Chacun peut devenir individuellement actif.<br />
<br />
Enfin, si un jour nebule s’étend à toutes les machines et que toutes ces machines l’implémentent nativement, alors le projet klicty disparaîtra.
...
Il sera vu comme bizarrerie symptomatique d’une époque.",
            '::module:help:APropos:Liens' => 'Voir aussi :<br /><a href="http://blog.klicty.org/">Le blog du projet klicty</a><br /><a href="http://blog.nebule.org/">Le blog du projet nebule</a>',
...
The klicty project provides access to this new way of managing our information without questioning fundamentally the organization including the operating system of our information systems.<br />
<br />
The klicty interface is a web page to be set up on a server to handle objects and links.
...
<br />
The project klicty reproduced concentration data to servers on the Internet.
It is expected to be natively installed on any web server.
And, based on the principles of nebule, any server hosting klicty can natively:<br />
...
Everyone can simply set up klicty at home, or continue using another Internet server.
Each individual can become active.<br />
<br />
Finally, if one day nebule extends to all machines and all these machines implement it natively, then the project klicty will disappear.
He will have served its purpose: to allow a smooth transition to nebule.<br />
It will be seen as symptomatic of an era oddity.',
            '::module:help:APropos:Liens' => 'See also :<br /><a href="http://blog.klicty.org/">The blog of klicty projet</a><br /><a href="http://blog.nebule.org/">the blog of nebule projet</a>',
...
El proyecto klicty proporciona acceso a esta nueva forma de gestionar nuestra información sin cuestionar en profundidad la organización incluyendo el sistema operativo de nuestros sistemas de información.<br />
<br />
La interfaz klicty es una página web que se creará en el servidor para manejar objetos y enlaces.
...
<br />
El klicty proyecto reproduce datos de concentración a los servidores de Internet.
Se espera que esté instalado de forma nativa en cualquier servidor web.
Y, en base a los principios de nebule, cualquier servidor de alojamiento klicty puede nativa:<br />
...
Todo el mundo puede simplemente configurar klicty casa, o continuar utilizando otro servidor de Internet.
Cada individuo puede llegar a ser activo.<br />
<br />
Por último, si un día nebule se extiende a todas las máquinas y todas estas máquinas implementar de forma nativa, entonces el proyecto klicty desaparecer.
Él habrá cumplido su propósito: permitir una transición suave a nebule.
Se verá como un síntoma de una rareza era.',
            '::module:help:APropos:Liens' => 'Ver también :<br /><a href="http://blog.klicty.org/">El blog del proyecto klicty</a><br /><a href="http://blog.nebule.org/">El blog del proyecto nebule</a>',
